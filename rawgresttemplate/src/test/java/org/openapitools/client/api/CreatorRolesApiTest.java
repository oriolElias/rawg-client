...
/**
 * API tests for CreatorRolesApi
 */
@Ignore
public class CreatorRolesApiTest {

    private final CreatorRolesApi api = new CreatorRolesApi();
     ...
     */
    @Test
    public void creatorRolesListTest() {
        Integer page = null;
        Integer pageSize = null;
        CreatorRolesList200Response response = api.creatorRolesList(page, pageSize);
