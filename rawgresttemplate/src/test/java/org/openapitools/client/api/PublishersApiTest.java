...
public class PublishersApiTest {
     ...
     */
    @Test
    public void publishersListTest() {
        Integer page = null;
        Integer pageSize = null;
        PublishersList200Response response = api.publishersList(page, pageSize);
     ...
     */
    @Test
    public void publishersReadTest() {
        Integer id = null;
        PublisherSingle response = api.publishersRead(id);
