 ...
 */
@JsonPropertyOrder({
  GamePlatformMetacritic.JSON_PROPERTY_METASCORE,
  GamePlatformMetacritic.JSON_PROPERTY_URL
})
...
public class GamePlatformMetacritic {
  public static final String JSON_PROPERTY_METASCORE = "metascore";
  ...
  @JsonCreator
  public GamePlatformMetacritic(
    @JsonProperty(JSON_PROPERTY_METASCORE) Integer metascore, 
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_METASCORE)
